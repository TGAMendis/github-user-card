...
class Repo extends React.Component {
  render() {
    let { repo } = this.props;
    return /*#__PURE__*/(
      React.createElement("a", { className: "repository", href: repo.html_url }, /*#__PURE__*/
      React.createElement("div", { className: "repo-info" }, /*#__PURE__*/
      React.createElement("div", null, /*#__PURE__*/React.createElement("i", { className: "fa fa-star" }), /*#__PURE__*/
      React.createElement("span", null), /*#__PURE__*/React.createElement("span", { className: "title" }, repo.name)))));
...
class DataChart extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      React.createElement("div", { className: "chart" }, /*#__PURE__*/
...
class RepoChart extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/(
      React.createElement("div", { className: "pie-chart-wrap" }, /*#__PURE__*/
      React.createElement("div", { className: "pie-chart-totals" }, /*#__PURE__*/
      React.createElement("i", { className: "fa fa-star" }), totals), /*#__PURE__*/
...
class Card extends React.Component {
  render() {
    ...
    slice(0, 3);
    let repos = reposData.
    map((r, i) => /*#__PURE__*/React.createElement(Repo, { key: i, repo: r }));
    ...
    return /*#__PURE__*/(
      ...
      React.createElement("a", { className: "userlink", href: this.props.user.html_url },
      this.props.user.login, /*#__PURE__*/
      React.createElement("i", { className: "fa fa-link" })), /*#__PURE__*/


      React.createElement("div", { className: "avatar" }, /*#__PURE__*/
      React.createElement("img", { src: this.props.user.avatar_url })), /*#__PURE__*/


      React.createElement("span", { className: "repos-count" },
      this.props.user.public_repos), /*#__PURE__*/


      React.createElement("div", { className: "userinfo" }, /*#__PURE__*/
      React.createElement("h2", null, this.props.user.name || this.props.user.login), /*#__PURE__*/
      React.createElement("p", null, this.props.user.location))), /*#__PURE__*/


      React.createElement("div", { className: "totals" }, /*#__PURE__*/
      React.createElement("div", null,
      this.props.user.followers, /*#__PURE__*/
      React.createElement("div", { className: "desc" }, "Followers")), /*#__PURE__*/

      React.createElement("div", null,
      starred, /*#__PURE__*/
      React.createElement("div", { className: "desc" }, "Total stars")), /*#__PURE__*/

      React.createElement("div", null,
      forked, /*#__PURE__*/
      React.createElement("div", { className: "desc" }, "Times Forked"))), /*#__PURE__*/



      React.createElement(DataChart, { events: this.props.events }), /*#__PURE__*/

      React.createElement("br", null), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/
      React.createElement("div", { className: "super-line" }, "TOP Rated"), /*#__PURE__*/
...
class Application extends React.Component {
  ...
  render() {
    ...
    React.createElement(Card, { user: this.state.user, repos: this.state.repos, events: this.state.events }) : /*#__PURE__*/
    React.createElement("div", { className: "loading" }, /*#__PURE__*/React.createElement("span", null), /*#__PURE__*/React.createElement("span", null), /*#__PURE__*/React.createElement("span", null), /*#__PURE__*/React.createElement("span", null), /*#__PURE__*/React.createElement("span", null));
...
ReactDOM.render( /*#__PURE__*/React.createElement(Application, null),
